...
console.log(parseInt('15,123', 10));    // 콤마(,)는 단순 문자열이므로 콤마 이후는 버려짐
console.log(parseInt('FXX123', 16));    // 16진수 기준 정상숫자인 F는 인식되지만 문자열 X 이후로는 버려짐
console.log(parseInt('1111', 2));  
console.log(parseInt('15*3', 10));  // 문자열에서 '*'는 곱하기가 아니라 단순 글자이므로 '*'는 버려짐
console.log(parseInt('15e2', 10));  // 문자열 'e'이후는 버려짐
console.log(parseInt('15px', 10));  // 문자열 'px'는 버려짐
