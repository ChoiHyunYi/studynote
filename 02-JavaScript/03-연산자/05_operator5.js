...
let compare2 = x > y;      // 100은 50을 '초과'한다. --> 말이 됨, 참 -> true
let compare3 = x <= y;      // 100은 50 '이하'이다. --> 말이 안됨, 거짓 -> false
let compare4 = x < y;      // 100은 50 '미만'이다. --> 말이 안됨, 거짓 -> false

console.group("1) 이상, 이하, 미만, 초과");
console.log(compare1);      // true
console.log(compare2);      // true
console.log(compare3);      // fasle
console.log(compare4);      // fasle
console.groupEnd();
...
console.log(a1 === a2);     // 두 값이 다르므로 결과는 fasle
console.log(a1 === a3);     // 두 값이 다르므로 결과는 fasle
console.log(a1 === a4);     // 두 값이 다르므로 결과는 fasle

console.log(a2 === a3);     // 두 값이 같으므로 결과는 true
console.log(a2 === a4);     // 두 값이 다르므로 결과는 fasle

console.log(a3 === a4);     // 두 값이 다르므로 결과는 fasle
console.groupEnd();
console.groupEnd();
...
console.group("3) 다르다");
console.group("내용만 비교하는 경우");
console.log(b1 != b2);      // 두 값이 같으므로 결과는 fasle
console.log(b1 != b3);      // 두 값이 같으므로 결과는 fasle
console.log(b1 != b4);      // 두 값이 같으므로 결과는 fasle

console.log(b2 != b3);      // 두 값이 같으므로 결과는 fasle
console.log(b2 != b4);      // 두 값이 같으므로 결과는 fasle

console.log(b3 != b4);      // 두 값이 같으므로 결과는 fasle
console.groupEnd();
